...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/nikarefin/Yandex.Disk.localized/Skillfactory/news_portal/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/nikarefin/Yandex.Disk.localized/Skillfactory/news_portal/venv/bin/deactivate.nu'
